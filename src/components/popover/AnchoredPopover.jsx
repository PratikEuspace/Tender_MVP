/**
 * Anchored popover overlay — positions children below a measured field.
 * Uses a transparent full-screen layer only for z-index above ScrollView content
 * (not a centered dialog or bottom sheet).
 */
...
const AnchoredPopover = ({
  ...
  const layout = useMemo(
    () => computeAnchoredLayout(anchor, contentHeight, { minWidth }),
    [anchor, contentHeight, minWidth],
  );
